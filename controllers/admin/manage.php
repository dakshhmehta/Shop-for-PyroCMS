...
class Manage extends Admin_Controller 
{
	...
	public function index() 
	{
		...
		{
			$this->data->$set_name = $this->folders(Settings::get($set_name), $set_name);
		}
	
		$this->data->shop_admin_login_location = $this->shop_admin_login_location('shop_admin_login_location');

		// Build the view with shop/views/admin/items.php
		//$this->data->items = & $items;
		$this->template->title($this->module_details['name'])
			->build('admin/manage/main', $this->data);				
	}

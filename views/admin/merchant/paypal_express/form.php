<ul>
	<li class="<?php echo alternator('even', 'odd') ?>">
		<label><?php echo lang('shop:gateways:test_mode');?></label>
		<div class="input">
	...
	<li class="<?php echo alternator('even', 'odd') ?>">
		<label><?php echo lang('shop:gateways:auto_submit');?><small></small></label>
		<div class="input">

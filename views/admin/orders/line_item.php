		...
		<?php if ($items) : ?>
			<?php foreach ($items as $order) : ?>
				<tr>
					...
					<td> 
						<?php echo anchor('admin/shop/orders/order/' . $order->id, $order->customer_name, array('class'=>'nc_links',  'title' => lang('shop:orders:view') ) ); ?>
					</td>
					...
					<td>
						<span style="float:right;">
								...
								<a href="<?php echo 'admin/shop/orders/order/' . $order->id;?>" class="shopbutton button-rounded button-flat-primary"><?php echo lang('shop:orders:view');?></a>

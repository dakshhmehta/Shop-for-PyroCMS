	...
	<div  class="content">
		<fieldset>
			<ul>
				...
				<li class="<?php echo alternator('', 'even'); ?>">
					<label for="method"><?php echo lang('method'); ?></label>
					<div class="input">
						<?php echo $method_select; ?> 
					</div>
				</li>  				
				<li class="<?php echo alternator('', 'even'); ?>">
					<label for="value"><?php echo lang('value'); ?> <span>*</span> - for blocking by country, ONLY use the 2 letter ISO country code (i.e : AU for Australia)</label>
					<div class="input"><?php echo form_input('value', set_value('value', $value)); ?></div>
				</li>				  
				<li class="<?php echo alternator('', 'even'); ?>">
					<label for="brand_id">Enabled<span></span>
						<small>
						</small>
					</label>
					<div class="input">
